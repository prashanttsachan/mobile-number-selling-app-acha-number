    							...
    							<?php $i=1; foreach($numbers as $row): ?>
    								<tr>
    									...
    									<td>
    										...
    										<a class="btn btn-success btn-xs" alt="Mark sold" title="Mark sold" href="<?php echo base_url(''); ?>postpaid_active_numbers?pid=<?php echo $row->id; ?>" onclick="return confirm('Are you sure to mark it as Sold?')">
